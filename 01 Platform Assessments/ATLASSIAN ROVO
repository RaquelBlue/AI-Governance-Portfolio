#Platform Overview - Atlassian Rovo
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#| Staff executes a Rovo Cross-App Search  | Indexes active Confluence pages, Google Drive, | Rovo Search Enterprise Indexing Engine | Rendered as a secure summary on |
#|                                         | folders, and Microsoft 365 docs based on user  | (Secure Cloud)                         | the user's local screen.        |
#|                                         | permissions.                                   |                                        |                                 |
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#| Staff interacts with Rovo Chat to       | Reads historical Jira ticket attributes,       | Atlassian LLM Gateway (Contextual      | Modifies the target Jira issue  |
#| update a task                           | comments, and the explicit text prompt typed   | parsing)                               | via Atlassian internal API.     |
#|                                         | by the staff member.                           |                                        |                                 |
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#| Custom Rovo Agent processes meeting     | Ingests full text or transcript of community   | Rovo Studio Engine/Configured Agent    | Generates and distributes new   |
#| notes                                   | event planning meetings stored in Google Docs. | Knowledge Base                         | Jira tickets to designated      |
#|                                         |                                                |                                        | staff.                          |
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
